...
I see there is [a pull request](https://github.com/mastodon/mastodon/pull/16210) on upstream that contains changes to use TypeScript, which is great, I'll keep an eye on it.
